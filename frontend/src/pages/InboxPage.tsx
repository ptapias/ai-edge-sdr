...
export default function InboxPage() {
  ...
  const findLeadForChat = (chat: Chat): Lead | undefined => {
    ...
    return leadsData.leads.find(lead =>
      lead.linkedin_provider_id === chat.attendee_provider_id ||
      (lead.first_name && chat.name?.includes(lead.first_name))
    )
  }
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between">
                          <p className="font-medium text-gray-900 truncate">
                            {chat.name || lead?.first_name || 'Unknown'}
                          </p>
                          {chat.unread_count ? (
            ...
            <>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">
                      {selectedChat.name || findLeadForChat(selectedChat)?.first_name || 'Unknown'}
                    </p>
                    ...
                    >
                      ...
                      >
                        ...
                        <p className={`text-xs mt-1 ${
                          msg.is_outbound ? 'text-blue-200' : 'text-gray-400'
                        }`}>
              ...
              <div className="p-4 border-t">
                <div className="flex gap-2">
                  <button
                    onClick={() => {
                      // TODO: Implement AI reply suggestion
                      setGeneratingReply(true)
                      setTimeout(() => {
                        setMessageText("Thanks for connecting! I'd love to learn more about your work. Would you be open to a brief call?")
